                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          courseWidget('Flutter', 'Flutter Dasar', 'img1',
                              Color(0xffff6a65), Color(0xffff5954)),
                          SizedBox(
                            height: 20,
                          ),
                          courseWidget('Membuat Hello World', 'Membuat Widget',
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          courseWidget('Pemrograman', 'Flutter untuk semua',
                              'img3', Color(0xffe9eefa), Colors.white),
                          SizedBox(
                            height: 20,
                          ),
                          courseWidget('Flutter', 'Dasar Flutter', 'img4',
